...
import {
  Github, Star, GitFork, Users, Calendar, MapPin, Link as LinkIcon,
  ExternalLink, Loader2, Search, Code2, Building
} from 'lucide-react';
...
const Index = () => {
  ...
  const openRepository = (url: string) => window.open(url, '_blank');
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Discover developers</h2>
              ...
              <CardHeader className="pb-6">
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="flex-grow">
                    ...
                    {profile.bio && (
                      <p className="text-gray-700 mb-6 text-base leading-relaxed">{profile.bio}</p>
                    )}
        ...
        {repositories.length > 0 && (
          <div>
            <div className="flex items-center gap-3 mb-8">
              ...
              <h3 className="text-2xl font-bold text-gray-900">Popular Repositories</h3>
              ...
              {repositories.map((repo) => (
                ...
                >
                  ...
                  <CardContent className="pt-0">
                    ...
                    {repo.language && (
                      <Badge className="text-xs border-gray-300 text-gray-600">
                        {repo.language}
                      </Badge>
                    )}
                  </CardContent>
        ...
        {!profile && !loading && (
          <div className="text-center py-20">
            <div className="max-w-md mx-auto">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Start exploring</h3>
