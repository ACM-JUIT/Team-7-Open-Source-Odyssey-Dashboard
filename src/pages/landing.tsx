...
const Landing = () => {
  ...
  useEffect(() => {
    const fetchSampleProfile = async () => {
      try {
        const res = await fetch('http://localhost:5000/github/profile/octocat'); // example
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <Link to="/app" className="text-gray-600 hover:text-gray-900 transition-colors">Demo</Link>
              <Link to="/login">
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Show sample profile from backend */}
          {profile && (
